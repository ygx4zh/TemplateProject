...
*/
public class AppConfigDao extends AbstractDao<AppConfig, String> {
    ...
    @Override
    protected final String updateKeyAfterInsert(AppConfig entity, long rowId) {
        return entity.getKey();
    }
    
    @Override
    public String getKey(AppConfig entity) {
        if(entity != null) {
            return entity.getKey();
        } else {
            return null;
